...
# where <name of the script> is the file name of the script, <datadir>
# points to the simulations data directory, <topology> is a string containing
# the topology, <dim> is a string concatenating the network dimensions by the
# character 'x', and <val> is a numerical value indicating the acceleration
# factor (acc)
#
#####################################################################################
INFILE = sprintf('%s/Delays/Delays_%s_%s_256_npn_MC_acc_%03d.csv', ARG1, ARG2, ARG3, ARG4 + 0)
OUTFILE = sprintf('%s/Images/Delays_%s_%s_256_npn_MC_acc_%03d.pdf', ARG1, ARG2, ARG3, ARG4 + 0)
...
set xtics (sprintf('%s %s MC', ARG3, ARG2) 1)
