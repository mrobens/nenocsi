 ...
 * 
 * 2022-09-14: This file declares the parameters needed by rtparser to convert a 
 *             connectivity file created by NEST to a routing table. In this file, 
 *             only struct GlobalParams with a few global parameters is retained.
 *
 *///******************************************************************************** 

#ifndef __MCAERSIMRTPARSER_H__
#define __MCAERSIMRTPARSER_H__
...
struct GlobalParams
{
  ...
  static int number_pes;
  static int nrs_p_node;
  static std::string topology;
  static std::string output_file_name;
};

#endif /* __MCAERSIMRTPARSER_H__ */
