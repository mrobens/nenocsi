 ...
 * 
 * Extension for proper conversion of casting types.
 * Modifications are highlighted by comments consisting of initials and date.
 *
 *///******************************************************************************** 

#ifndef __NENOCSICONFIGURATIONMANAGER_H__                                                                                                      // MR: Modified 2023/04/21
#define __NENOCSICONFIGURATIONMANAGER_H__                                                                                                      // MR: Modified 2023/04/21
...
namespace YAML {
    ...
    template<>                                                                                                                                 // MR: Added 2022/03/30
    struct convert<CastingType> {                                                                                                              // MR: Added 2022/03/30
        static bool decode(const Node& node, CastingType& cst_type) {                                                                          // MR: Added 2022/03/30
	    cst_type = node.as<string>().compare("UC") ? LMC : UC;                                                                             // MR: Added 2022/03/30
	    return true;                                                                                                                       // MR: Added 2022/03/30
	}                                                                                                                                      // MR: Added 2022/03/30
    };                                                                                                                                         // MR: Added 2022/03/30
}
#endif
