 ...
 *
 * 2022-09-01: Original creation of this file containing the implementation
...
void Arbiter::reserve(const int port_in)
{
  // Execution in the case that there is still a reservation is illegal.
  // Should be assured by users of the arbiter
  assert(isAvailable());
  reserved = true;
  granted_input = port_in;
}

void Arbiter::release()
{
  // Check that arbiter is still reserved
