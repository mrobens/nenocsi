 ...
 * 
 * A pointer to the instance of GlobalNestTrace is stored as attribute. Furthermore,
 * an attribute to store the number of queued flits is added. Finally, two functions 
 * are declared that return the number of queued flits and help with the assignment 
 * of virtual channels in case of a torus shaped network, respectively.
 *  
 * Modifications are highlighted by comments consisting of initials and date.
 *
 *///******************************************************************************** 

#ifndef __NENOCSIPROCESSINGELEMENT_H__                                                                                                         // MR: Modified 2023/04/21
#define __NENOCSIPROCESSINGELEMENT_H__                                                                                                         // MR: Modified 2023/04/21
...
SC_MODULE(ProcessingElement)
{
    ...
    long queuedFlits;           // Holds the number of queued flits                                                                             - MR: Added 2022/04/08
    ...
    long getQueuedFlits() const;// Returns the number of queued flits                                                                           - MR: Added 2022/04/08

    GlobalTrafficTable *traffic_table;	// Reference to the Global traffic Table
    GlobalNestTrace *nest_trace; // Refernce to the global NEST trace                                                                          // MR: Added 2022/03/28
    ...
    int id2vcTorus(int src_id, int dst_id);                                                                                                    // MR: Added 2022/04/26
	...
	queuedFlits = 0;                                                                                                                       // MR: Added 2022/04/08
    }
