 ...
 * 
 * Global parameters, string constants as well as an enumeration were added to 
 * account for additional features.
 * Modifications are highlighted by comments consisting of initials and date.
 *
 *///******************************************************************************** 

#ifndef __NENOCSIGLOBALPARAMS_H__                                                                                                              // MR: Modified 2023/04/21
#define __NENOCSIGLOBALPARAMS_H__                                                                                                              // MR: Modified 2023/04/21
...
#define NEST_INPUT_FILENAME    "MC_Transmissions.yaml"                                                                                         // MR: Added 2022/03/28
...
#define TOPOLOGY_TORUS         "TORUS"                                                                                                         // MR: Added 2022/04/11
...
#define TRAFFIC_NEST_TRACE     "TRAFFIC_NEST_TRACE"                                                                                            // MR:Added 2022/03/28
...
enum CastingType                                                                                                                               // MR: Added 2022/03/28
  {                                                                                                                                            // MR: Added 2022/03/28
   UC, // Unicast                                                                                                                              // MR: Added 2022/03/28
   LMC // Local Multicast                                                                                                                      // MR: Added 2022/03/28
  };                                                                                                                                           // MR: Added 2022/03/28
...
struct GlobalParams {
    ...
    static string nest_input_filename;                                                                                                         // MR: Added 2022/03/28
    // Conversion between NEST and Noxim time units
    static double nest_time_multiplier;                                                                                                        // MR: Added 2022/10/10 
    static CastingType casting_type;                                                                                                           // MR: Added 2022/03/28
    ...
    static bool create_output_files;                                                                                                           // MR: Added 2022/04/04
    static string ofile_suffix;                                                                                                                // MR: Added 2022/04/04
};
