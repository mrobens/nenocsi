 ...
 * 
 * Formatting of the output stream in ShowStats(...) was changed.
...
{
  if (true_buffer)
    out << setw(8) << left << fixed << setprecision(4) << mean_occupancy << setw(8) << max_occupancy;     // MR: Modified 2022/03/31
  else
