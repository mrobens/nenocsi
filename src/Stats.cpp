 ...
 * 
 * Support for single-flit packets as well as the definition of a function that
 * appends all delays stored within the communication history to the vector of
 * latencies were added.
...
void Stats::setDelays(vector<double>& overall_delays) const                                                                                    // MR: Added 2022/04/04
{                                                                                                                                              // MR: Added 2022/04/04
  for (unsigned int k=0; k < chist.size(); k++) {                                                                                              // MR: Added 2022/04/04
    if (chist[k].delays.size() > 0)                                                                                                            // MR: Added 2022/04/04
      overall_delays.insert(overall_delays.end(), chist[k].delays.begin(), chist[k].delays.end());                                             // MR: Added 2022/04/04
  }                                                                                                                                            // MR: Added 2022/04/04
}                                                                                                                                              // MR: Added 2022/04/04
