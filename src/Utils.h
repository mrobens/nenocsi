 ...
 * 
 * Support for single-flit packets as well as torus shaped networks is added.
 *
 * Modifications are highlighted by comments consisting of initials and date.
 *
 *///******************************************************************************** 
#ifndef __NENOCSIUTILS_H__
#define __NENOCSIUTILS_H__
...
inline ostream & operator <<(ostream & os, const Flit & flit)
{
	...
	case FLIT_TYPE_TAIL:
	    ...
	    break;
	case FLIT_TYPE_HEADTAIL:                                                                                                               // MR: Added 2022/09/18
	    os << "Flit Type is HEADTAIL" << endl;                                                                                             // MR: Added 2022/09/18
	    break;                                                                                                                             // MR: Added 2022/09/18
	}
