 ...
 * For the license applied to modifiactions and NENoCSi as a whole
 * refer to file ../doc/LICENSE_NENCOSI.txt
 * 
 * Modification to enable single-flit packets.
 * Modifications are highlighted by comments consisting of initials and date.
 *
 *///******************************************************************************** 

#ifndef _NENOCSIDATASTRUCS_H__                                                                                                                 // MR: Modified 2023/04/21
#define _NENOCSIDATASTRUCS_H__                                                                                                                 // MR: Modified 2023/04/21
...
enum FlitType {
    FLIT_TYPE_HEAD, FLIT_TYPE_BODY, FLIT_TYPE_TAIL, FLIT_TYPE_HEADTAIL                                                                         // MR: Modified 2022/09/22
};
...
struct Flit {
    ...
    FlitType flit_type;	// The flit type (FLIT_TYPE_HEAD, FLIT_TYPE_BODY, FLIT_TYPE_TAIL, FLIT_TYPE_HEADTAIL)                                     MR: Modified 2022/09/22
